...
function Header({
  ...
  return (
    ...
    >
      <div style={{ flex: 1 }}>
        <h1 style={{ margin: 0, fontSize: fs.title, fontWeight: 600, color: W.text }}>
          Doctor
        </h1>
        <p style={{ margin: "4px 0 0", color: W.dim, fontSize: fs.lead }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ color: W.text, fontSize: fs.data }}>
          {check.label}
          <span
            style={{
              marginLeft: 8,
