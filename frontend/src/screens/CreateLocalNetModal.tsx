...
function ModalHeader({
  ...
  return (
    ...
    >
      ...
      <div style={{ color: W.dim, fontSize: 13, marginTop: 3 }}>{subtitle}</div>
    </header>
  );
}
  ...
  return (
    <form onSubmit={onSubmit} style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      >
        ...
        />
        <div style={{ flex: 1, fontSize: 13, color: W.text2 }}>
          ...
          <div style={{ color: W.dim, fontSize: 13, marginTop: 3, lineHeight: 1.5 }}>
...
function SubmittingBody({ name }: { name: string }) {
  return (
    ...
    >
      ...
      <div style={{ color: W.faint, fontSize: 13 }}>
  ...
  if (banner.kind === "failed") {
    ...
    return (
      ...
      >
        ...
        {banner.cause && (
          <div style={{ color: W.text2, marginTop: 4, fontFamily: wMono, fontSize: 13 }}>
            {banner.cause}
          </div>
        )}
        {remediation && (
  ...
  return (
    ...
    >
      ...
      {state.report.summary && (
        <div style={{ color: W.text2, marginBottom: 8, fontSize: 13 }}>
          {state.report.summary}
        </div>
      )}
      {[...fails, ...warns].map(({ section, check }, i) => (
        ...
        >
          <div style={{ fontFamily: wMono, fontSize: 13 }}>
            <span
              style={{
...
function Field({
  ...
  return (
    <label style={{ display: "block" }}>
      ...
      {hint && !error && (
        <div style={{ color: W.dim, fontSize: 13, marginTop: 4 }}>{hint}</div>
      )}
    </label>
  );
}
