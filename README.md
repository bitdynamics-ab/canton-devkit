...
Download counts for the release assets published to [`homebrew-canton-devkit`](https://github.com/bitdynamics-ab/homebrew-canton-devkit) (the repo the [release workflow](.github/workflows/release.yml) mirrors every tagged build to). Charts + tables are regenerated daily by [`scripts/release-stats.sh`](scripts/release-stats.sh) via [`.github/workflows/release-stats.yml`](.github/workflows/release-stats.yml), summing each release asset's `download_count` — the same metric [gh-release-stats](https://github.com/RamiAwar/gh-release-stats) tracks, reimplemented here as static SVGs since README markdown can't run that tool's client-side JS.

<p align="center">
  <img src="docs/assets/release-downloads-by-platform.svg" alt="Downloads per platform, per release" width="49%">
  <img src="docs/assets/release-downloads-by-version.svg" alt="Total downloads per release" width="49%">
</p>
<p align="center">
  <img src="docs/assets/release-downloads-totals-by-version.svg" alt="All-time downloads per release" width="49%">
  <img src="docs/assets/release-downloads-totals-by-platform.svg" alt="All-time downloads per platform" width="49%">
</p>
...
Want a different repo or a CSV export? Run the same query live at [gh-release-stats](https://ramiawar.github.io/gh-release-stats/).
