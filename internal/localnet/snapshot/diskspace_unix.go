...
// containing dir. Used by RunRestore's preflight to refuse a restore
// that would fill the disk. statfs is the standard POSIX path; any
// error here is treated as "preflight unavailable" by the caller,
// which proceeds without the gate.
