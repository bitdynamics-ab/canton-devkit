...
export const docsMap = [
  ...
  { src: 'localnet-lifecycle.md', dest: 'guides/localnet-lifecycle', description: 'What Canton LocalNet is, and how to start, inspect, run multiple instances, pin ports, and tear down a DevKit-managed LocalNet.' },
  ...
  { src: 'faq.md', dest: 'reference/faq', description: 'FAQ: what Canton LocalNet is, how to start it with DevKit, DevKit vs cn-quickstart, CLI vs Web UI, versions, and tokens.' },
